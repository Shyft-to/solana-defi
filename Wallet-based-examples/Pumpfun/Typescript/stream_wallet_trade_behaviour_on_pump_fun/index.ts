...
const WALLET_PROGRAM_ID = new PublicKey("winYp2B9RL4kZ7KBy4r9KWqhnwrCrjvbmiVXSha29Ft");
...
async function handleStream(client: Client, args: SubscribeRequest) {
  console.log("Streaming Wallet Trade Behaviour on Pumpfun...")
...
const req: SubscribeRequest = {
  ...
  transactions: {
    pumpFun: {
      ...
      accountExclude: [],
      accountRequired: [WALLET_PROGRAM_ID.toBase58()],
    },
  },
  transactionsStatus: {},
  entry: {},
