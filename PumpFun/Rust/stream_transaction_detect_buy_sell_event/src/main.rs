...
struct ParsedEventTransaction {
    ...
    pub market_details: TransactionEvent
}
...
pub fn parsed_pump_txn(
    ...
    // Extract amount_in from instruction data
    ...
    // Extract quote_amount_out from inner transfer instructions
    let sol_amount = meta
    .inner_instructions
    .iter()
    ...
    // Extract mint and bonding curve
