...
const PUMPFUN_MINT_AUTHORITY: &str = "39azUYFWPz3VHgKCf3VChUwbpURdCHRxjWVowf5jUJjg";
    ...
    pub fn get_txn_updates(&self) -> anyhow::Result<SubscribeRequest> {
        ...
        transactions.insert(
            ...
            SubscribeRequestFilterTransactions {
                vote: Some(false),
                failed: Some(false),
                account_include: vec![PUMPFUN_AMM_PROGRAM_ID.to_string(), PUMPFUN_MINT_AUTHORITY.to_string()],
                account_exclude: vec![],
