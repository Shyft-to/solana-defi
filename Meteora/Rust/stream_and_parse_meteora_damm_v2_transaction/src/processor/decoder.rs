...
use meteora_damm_interface::instructions::MeteoraDammProgramIx;
...
impl TransactionProcessor{
    ...
    pub fn decode_single_instruction(
        ...
        if instruction.instruction.program_id == self.meteora_damm_v2_program_id {
    ...
    pub fn decode_meteora_dbc_instruction(
        ...
        match MeteoraDammProgramIx::deserialize(&instruction.instruction.data) {
            Ok(decoded_ix) => {
                let mapped_accounts = self.meteora_damm_v2_idl.map_accounts(
