...
pub const CLOSE_TOKEN_BADGE_IX_ACCOUNTS_LEN: usize = 5;
#[derive(Copy, Clone, Debug)]
...
pub const SPLIT_POSITION_ACCOUNTS_LEN: usize = 9;
#[derive(Copy,Clone, Debug)]
...
impl From<SplitPositionKeys> for [AccountMeta; SPLIT_POSITION_ACCOUNTS_LEN]{
...
impl From<[Pubkey; SPLIT_POSITION_ACCOUNTS_LEN]> for SplitPositionKeys {
    fn from(pubkeys: [Pubkey; SPLIT_POSITION_ACCOUNTS_LEN]) -> Self {
        Self {
            pool: pubkeys[0],
...
impl<'info> From<SplitPositionAccounts<'_, 'info>> for [AccountInfo<'info>; SPLIT_POSITION_ACCOUNTS_LEN] {
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; SPLIT_POSITION_ACCOUNTS_LEN]> for SplitPositionAccounts<'me, 'info> {
    fn from(arr: &'me [AccountInfo<'info>; SPLIT_POSITION_ACCOUNTS_LEN]) -> Self {
        Self {
            pool: &arr[0],
...
pub fn split_position_ix_with_program_id(
    ...
    let metas: [AccountMeta; SPLIT_POSITION_ACCOUNTS_LEN] = keys.into();
...
pub fn split_position_ix(keys: SplitPositionKeys, args: SplitPositionIxArgs) -> std::io::Result<Instruction> {
...
pub fn split_position_invoke(accounts: SplitPositionAccounts<'_, '_>, args: SplitPositionIxArgs) -> ProgramResult {
