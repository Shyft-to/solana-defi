...
use crate::METEORA_DBC_PROGRAM_ID;
...
pub struct TransactionProcessor {
    pub meteora_dbc_idl: Idl,
    pub token_idl: Idl,
    pub meteora_dbc_program_id: Pubkey,
...
impl TransactionProcessor {
    pub fn new() -> anyhow::Result<Self> {
        ...
        Ok(Self {
            ...
            meteora_dbc_program_id: Pubkey::from_str(METEORA_DBC_PROGRAM_ID)?,
    ...
    update: SubscribeUpdateTransaction,
      ...
      let txn_info: Option<yellowstone_grpc_proto::prelude::SubscribeUpdateTransactionInfo> = update.transaction;
        ...
        if let Some(txn_info) = txn_info {
            ...
            Ok(self.meteoradbc_transaction_output(parsed_txn))
        } else {
            Ok(None)
     }
}
