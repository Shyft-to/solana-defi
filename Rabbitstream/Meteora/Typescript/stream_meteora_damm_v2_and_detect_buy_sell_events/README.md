...
This project streams and parses Meteora dammV2 transactions on the Solana blockchain using Rabbitstream. By tracking buy and sell events in real-time, it provides valuable insights into on-chain market activity, enabling users to better understand market trends, trading behavior, and liquidity flow within the Meteora ecosystem.
...
1. **Clone the repository:**
   ...
   cd Rabbitstream/Meteora/Typescript/stream_meteora_dammV2_and_detect_buy_sell_events
   ```
