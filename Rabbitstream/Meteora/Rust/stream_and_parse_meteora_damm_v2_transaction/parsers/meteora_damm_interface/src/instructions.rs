...
pub enum MeteoraDammProgramIx {
    ...
    CreateTokenBadge,
    DummyIx(DummyIxArgs),
    FixConfigFeeParams(FixConfigFeeParamsIxArgs), 
    FixPoolFeeParams(FixPoolFeeParamsIxArgs),
    ...
    LockInnerPosition(LockInnerPositionIxArgs),
    ...
    SplitPosition(SplitPositionIxArgs), 
    SplitPosition2(SplitPosition2IxArgs), 
    Swap(SwapIxArgs),
    Swap2(Swap2IxArgs), 
    UpdatePoolFees(UpdatePoolFeesIxArgs), //new
    ...
    ZapProtocolFee(ZapProtocolFeeIxArgs) //new
}
...
impl MeteoraDammProgramIx {
    ...
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        ...
        match maybe_discm {
            ...
            CLAIM_PARTNER_FEE_IX_DISCM => Ok(Self::ClaimPartnerFee(ClaimPartnerFeeIxArgs::deserialize(&mut reader)?)),
            CLAIM_POSITION_FEE_IX_DISCM => Ok(Self::ClaimPositionFee),
            CLAIM_PROTOCOL_FEE_IX_DISCM => Ok(Self::ClaimProtocolFee),
            CLAIM_REWARD_IX_DISCM => Ok(Self::ClaimReward(ClaimRewardIxArgs::deserialize(&mut reader)?)),
            CLOSE_CLAIM_FEE_OPERATOR_IX_DISCM => Ok(Self::CloseClaimFeeOperator),
            CLOSE_CONFIG_IX_DISCM => Ok(Self::CloseConfig),
            CLOSE_OPERATOR_ACCOUNT_IX_DISCM => Ok(Self::CloseOperatorAccount),
            CLOSE_POSITION_IX_DISCM => Ok(Self::ClosePosition),
            CLOSE_TOKEN_BADGE_IX_DISCM => Ok(Self::CloseTokenBadges),
            CREATE_CLAIM_FEE_OPERATOR_IX_DISCM => Ok(Self::CreateClaimFeeOperator),
            CREATE_CONFIG_IX_DISCM => Ok(Self::CreateConfig(CreateConfigIxArgs::deserialize(&mut reader)?)),
            CREATE_DYNAMIC_CONFIG_IX_DISCM => Ok(Self::CreateDynamicConfig(CreateDynamicConfigIxArgs::deserialize(&mut reader)?)),
            CREATE_OPERATOR_ACCOUNT_IX_DISCM => Ok(Self::CreateOperatorAccount(CreateOperatorAccountIxArgs::deserialize(&mut reader)?)),
            CREATE_POSITION_IX_DISCM => Ok(Self::CreatePosition),
            CREATE_TOKEN_BADGE_IX_DISCM => Ok(Self::CreateTokenBadge),
            DUMMY_IX_DISCM => Ok(Self::DummyIx(DummyIxArgs::deserialize(&mut reader)?)),
            FIX_CONFIG_FEE_PARAMS_IX_DISCM => Ok(Self::FixConfigFeeParams(FixConfigFeeParamsIxArgs::deserialize(&mut reader)?)),
            FIX_POOL_FEE_PARAMS_IX_DISCM => Ok(Self::FixPoolFeeParams(FixPoolFeeParamsIxArgs::deserialize(&mut reader)?)),
            FUND_REWARD_IX_DISCM => Ok(Self::FundReward(FundRewardIxArgs::deserialize(&mut reader)?)),
            INITIALIZE_CUSTOMIZABLE_POOL_IX_DISCM => Ok(Self::InitializeCustomizablePool(InitializeCustomizablePoolIxArgs::deserialize(&mut reader)?)),
            INITIALIZE_POOL_IX_DISCM => Ok(Self::InitializePool(InitializePoolIxArgs::deserialize(&mut reader)?)),
            INITIALIZE_POOL_WITH_DYNAMIC_CONFIG_IX_DISCM => Ok(Self::InitializePoolWithDynamicConfig(InitializePoolWithDynamicConfigIxArgs::deserialize(&mut reader)?)),
            INITIALIZE_REWARD_IX_DISCM => Ok(Self::InitializeReward(InitializeRewardIxArgs::deserialize(&mut reader)?)),
            LOCK_INNER_POSITION_IX_DISCM => Ok(Self::LockInnerPosition(LockInnerPositionIxArgs::deserialize(&mut reader)?)),
            LOCK_POSITION_IX_DISCM => Ok(Self::LockPosition(LockPositionIxArgs::deserialize(&mut reader)?)),
            PERMANENT_LOCK_POSITION_IX_DISCM => Ok(Self::PermanentLockPosition(PermanentLockPositionIxArgs::deserialize(&mut reader)?)),
            REFRESH_VESTING_IX_DISCM => Ok(Self::RefreshVesting),
            REMOVE_ALL_LIQUIDITY_IX_DISCM => Ok(Self::RemoveAllLiquidity(RemoveAllLiquidityIxArgs::deserialize(&mut reader)?)),
            REMOVE_LIQUIDITY_IX_DISCM => Ok(Self::RemoveLiquidity(RemoveLiquidityIxArgs::deserialize(&mut reader)?)),
            SET_POOL_STATUS_IX_DISCM => Ok(Self::SetPoolStatus(SetPoolStatusIxArgs::deserialize(&mut reader)?)),
            SPLIT_POSITION_IX_DISCM => Ok(Self::SplitPosition(SplitPositionIxArgs::deserialize(&mut reader)?)),
            SPLIT_POSITION2_IX_DISCM => Ok(Self::SplitPosition2(SplitPosition2IxArgs::deserialize(&mut reader)?)),
            ...
            UPDATE_POOL_FEES_IX_DISCM => Ok(Self::UpdatePoolFees(UpdatePoolFeesIxArgs::deserialize(&mut reader)?)),
            UPDATE_REWARD_DURATION_IX_DISCM => Ok(Self::UpdateRewardDuration(UpdateRewardDurationIxArgs::deserialize(&mut reader)?)),
            UPDATE_REWARD_FUNDER_IX_DISCM => Ok(Self::UpdateRewardFunder(UpdateRewardFunderIxArgs::deserialize(&mut reader)?)),
            WITHDRAW_INELIGIBLE_REWARD_IX_DISCM => Ok(Self::WithdrawIneligibleReward(WithdrawIneligibleRewardIxArgs::deserialize(&mut reader)?)),
            ZAP_PROTOCOL_FEE_IX_DISCM => Ok(Self::ZapProtocolFee(ZapProtocolFeeIxArgs::deserialize(&mut reader)?)),
    ...
    pub fn serialize<W: std::io::Write>(&self, mut writer: W) -> std::io::Result<()> {
        match self {
            ...
            Self::CloseOperatorAccount => writer.write_all(&CLOSE_OPERATOR_ACCOUNT_IX_DISCM),
            Self::ClosePosition => writer.write_all(&CLOSE_POSITION_IX_DISCM),
            Self::CloseTokenBadges => writer.write_all(&CLOSE_TOKEN_BADGE_IX_DISCM),
            ...
            Self::FixConfigFeeParams(args) => {
                writer.write_all(&FIX_CONFIG_FEE_PARAMS_IX_DISCM)?;
                args.serialize(&mut writer)
            }
            Self::FixPoolFeeParams(args) => {
                writer.write_all(&FIX_POOL_FEE_PARAMS_IX_DISCM)?;
                args.serialize(&mut writer)
            }
            ...
            Self::LockInnerPosition(args) => {
                writer.write_all(&LOCK_INNER_POSITION_IX_DISCM)?;
                args.serialize(&mut writer)
            }
            ...
            Self::SplitPosition(args) => {
                writer.write_all(&SPLIT_POSITION_IX_DISCM)?;
                args.serialize(&mut writer)
            }
            Self::SplitPosition2(args) => {
                writer.write_all(&SPLIT_POSITION2_IX_DISCM)?;
                args.serialize(&mut writer)
            }
            Self::Swap(args) => {
            ...
            Self::UpdatePoolFees(args) => {
                writer.write_all(&UPDATE_POOL_FEES_IX_DISCM)?;
                args.serialize(&mut writer)
            }
...
pub const CLOSE_OPERATOR_ACCOUNT_IX_ACCOUNTS_LEN: usize = 5;
...
impl From<CloseOperatorAccountKeys> for [AccountMeta; CLOSE_OPERATOR_ACCOUNT_IX_ACCOUNTS_LEN] {
...
impl From<[Pubkey; CLOSE_OPERATOR_ACCOUNT_IX_ACCOUNTS_LEN]> for CloseOperatorAccountKeys {
...
impl<'info> From<CloseOperatorAccountAccounts<'_, 'info>> for [AccountInfo<'info>; CLOSE_OPERATOR_ACCOUNT_IX_ACCOUNTS_LEN] {
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; CLOSE_OPERATOR_ACCOUNT_IX_ACCOUNTS_LEN]> for CloseOperatorAccountAccounts<'me, 'info> {
    fn from(arr: &'me [AccountInfo<'info>; CLOSE_OPERATOR_ACCOUNT_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            operator: &arr[0],
            signer: &arr[1],
            rent_receiver: &arr[2],
...
pub const CLOSE_OPERATOR_ACCOUNT_IX_DISCM: [u8; 8] = [171, 9, 213, 74, 120, 23, 3, 29];

#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq, Default)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CloseOperatorAccountIxArgs {}

#[derive(Clone, Debug, PartialEq)]
pub struct CloseOperatorAccountIxData(pub CloseOperatorAccountIxArgs);

impl From<CloseOperatorAccountIxArgs> for CloseOperatorAccountIxData {
    fn from(args: CloseOperatorAccountIxArgs) -> Self {
        Self(args)
    }
}
        ...
        if maybe_discm != CLOSE_OPERATOR_ACCOUNT_IX_DISCM {
            return Err(
                std::io::Error::new(
                    ...
                    format!(
                        "discm does not match. Expected: {:?}. Received: {:?}",
                        CLOSE_OPERATOR_ACCOUNT_IX_DISCM, maybe_discm
                    ),
                ),
            );
        }
        Ok(Self(CloseOperatorAccountIxArgs::deserialize(&mut reader)?))
    }
...
pub fn close_operator_account_ix_with_program_id(
    ...
    args: CloseOperatorAccountIxArgs,
) -> std::io::Result<Instruction> {
    let metas: [AccountMeta; CLOSE_OPERATOR_ACCOUNT_IX_ACCOUNTS_LEN] = keys.into();
    let data: CloseOperatorAccountIxData = args.into();
    Ok(Instruction {
        program_id,
        accounts: Vec::from(metas),
        data: data.try_to_vec()?,
...
pub fn close_operator_account_ix(
    ...
    close_operator_account_ix_with_program_id(crate::ID, keys, args)
}
...
pub fn close_operator_account_invoke_with_program_id(
    ...
    let ix = close_operator_account_ix_with_program_id(program_id, keys, args)?;
    invoke_instruction(&ix, accounts)
}
...
pub fn close_operator_account_invoke(
    ...
    close_operator_account_invoke_with_program_id(crate::ID, accounts, args)
}
...
pub fn close_operator_account_invoke_signed(
    ...
    close_operator_account_invoke_signed_with_program_id(crate::ID, accounts, args, seeds)
}
...
impl<'info> From<CloseTokenBadgeAccounts<'_, 'info>> for [AccountInfo<'info>; CLOSE_TOKEN_BADGE_IX_ACCOUNTS_LEN] {
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; CLOSE_TOKEN_BADGE_IX_ACCOUNTS_LEN]> for CloseTokenBadgeAccounts<'me, 'info> {
...
pub const CLOSE_TOKEN_BADGE_IX_DISCM: [u8; 8] = [108, 146, 86, 110, 179, 254, 10, 104];

#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq, Default)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CloseTokenBadgeIxArgs {}

#[derive(Clone, Debug, PartialEq)]
pub struct CloseTokenBadgeIxData(pub CloseTokenBadgeIxArgs);

impl From<CloseTokenBadgeIxArgs> for CloseTokenBadgeIxData {
    fn from(args: CloseTokenBadgeIxArgs) -> Self {
        Self(args)
    }
}
        ...
        if maybe_discm != CLOSE_TOKEN_BADGE_IX_DISCM {
            return Err(
                std::io::Error::new(
                    ...
                    format!(
                        "discm does not match. Expected: {:?}. Received: {:?}",
                        CLOSE_TOKEN_BADGE_IX_DISCM, maybe_discm
                    ),
                ),
            );
        }
        Ok(Self(CloseTokenBadgeIxArgs::deserialize(&mut reader)?))
    }
...
pub fn close_token_badge_ix_with_program_id(
    ...
    args: CloseTokenBadgeIxArgs,
) -> std::io::Result<Instruction> {
    let metas: [AccountMeta; CLOSE_TOKEN_BADGE_IX_ACCOUNTS_LEN] = keys.into();
    let data: CloseTokenBadgeIxData = args.into();
    Ok(Instruction {
        program_id,
        accounts: Vec::from(metas),
        data: data.try_to_vec()?,
...
pub fn close_token_badge_ix(
    keys: CloseTokenBadgeKeys,
    args: CloseTokenBadgeIxArgs,
) -> std::io::Result<Instruction> {
    close_token_badge_ix_with_program_id(crate::ID, keys, args)
}
...
pub fn close_token_badge_invoke_with_program_id(
    ...
    let ix = close_token_badge_ix_with_program_id(program_id, keys, args)?;
    invoke_instruction(&ix, accounts)
}
...
pub fn close_token_badge_invoke(
    ...
    close_token_badge_invoke_with_program_id(crate::ID, accounts, args)
}
...
pub fn close_token_badge_invoke_signed(
    ...
    close_token_badge_invoke_signed_with_program_id(crate::ID, accounts, args, seeds)
}
...
pub const CREATE_OPERATOR_ACCOUNT_IX_ACCOUNTS_LEN: usize = 7;

#[derive(Copy, Clone, Debug)]
pub struct CreateOperatorAccountAccounts<'me, 'info> {
    pub operator: &'me AccountInfo<'info>,
    pub whitelisted_address: &'me AccountInfo<'info>,
    pub signer: &'me AccountInfo<'info>,
...
impl From<CreateOperatorAccountAccounts<'_, '_>> for CreateOperatorAccountKeys {
    fn from(accounts: CreateOperatorAccountAccounts) -> Self {
        Self {
            operator: *accounts.operator.key,
            whitelisted_address: *accounts.whitelisted_address.key,
            signer: *accounts.signer.key,
...
impl From<CreateOperatorAccountKeys> for [AccountMeta; CREATE_OPERATOR_ACCOUNT_IX_ACCOUNTS_LEN] {
    fn from(keys: CreateOperatorAccountKeys) -> Self {
        [
            ...
            AccountMeta {
                pubkey: keys.whitelisted_address,
                is_signer: false,
                is_writable: false,
            },
            AccountMeta {
...
impl From<[Pubkey; CREATE_OPERATOR_ACCOUNT_IX_ACCOUNTS_LEN]> for CreateOperatorAccountKeys {
    fn from(pubkeys: [Pubkey; CREATE_OPERATOR_ACCOUNT_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            operator: pubkeys[0],
            whitelisted_address: pubkeys[1],
            signer: pubkeys[2],
            payer: pubkeys[3],
...
impl<'info> From<CreateOperatorAccountAccounts<'_, 'info>> for [AccountInfo<'info>; CREATE_OPERATOR_ACCOUNT_IX_ACCOUNTS_LEN] {
    fn from(accounts: CreateOperatorAccountAccounts<'_, 'info>) -> Self {
        [
            accounts.operator.clone(),
            accounts.whitelisted_address.clone(),
            accounts.signer.clone(),
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; CREATE_OPERATOR_ACCOUNT_IX_ACCOUNTS_LEN]> for CreateOperatorAccountAccounts<'me, 'info> {
    fn from(arr: &'me [AccountInfo<'info>; CREATE_OPERATOR_ACCOUNT_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            operator: &arr[0],
            whitelisted_address: &arr[1],
            signer: &arr[2],
            payer: &arr[3],
...
pub const CREATE_OPERATOR_ACCOUNT_IX_DISCM: [u8; 8] = [221, 64, 246, 149, 240, 153, 229, 163];
        ...
        if maybe_discm != CREATE_OPERATOR_ACCOUNT_IX_DISCM {
            return Err(
                std::io::Error::new(
                    ...
                    format!(
                        "discm does not match. Expected: {:?}. Received: {:?}",
                        CREATE_OPERATOR_ACCOUNT_IX_DISCM, maybe_discm
                    ),
                ),
            );
        }
        Ok(Self(CreateOperatorAccountIxArgs::deserialize(&mut reader)?))
    }
...
pub fn create_operator_account_ix(
    ...
    create_operator_account_ix_with_program_id(crate::ID, keys, args)
}
...
pub fn create_operator_account_invoke(
    ...
    create_operator_account_invoke_with_program_id(crate::ID, accounts, args)
}
...
pub fn create_operator_account_invoke_signed(
    ...
    create_operator_account_invoke_signed_with_program_id(crate::ID, accounts, args, seeds)
}
...
pub fn create_operator_account_verify_account_keys(
    ...
    for (actual, expected) in [
        (*accounts.operator.key, keys.operator),
        (*accounts.whitelisted_address.key, keys.whitelisted_address),
        (*accounts.signer.key, keys.signer),
...
pub const DUMMY_IX_ACCOUNTS_LEN: usize = 3;

#[derive(Copy, Clone, Debug)]
pub struct DummyIxAccounts<'me, 'info> {
    pub pod_aligned_fee_time_scheduler: &'me AccountInfo<'info>,
    pub pod_aligned_fee_rate_limiter: &'me AccountInfo<'info>,
    pub pod_aligned_fee_market_cap_scheduler: &'me AccountInfo<'info>,
}

#[derive(Copy, Clone, Debug, PartialEq)]
pub struct DummyIxKeys {
    pub pod_aligned_fee_time_scheduler: Pubkey,
    pub pod_aligned_fee_rate_limiter: Pubkey,
    pub pod_aligned_fee_market_cap_scheduler: Pubkey,
}

impl From<DummyIxAccounts<'_, '_>> for DummyIxKeys {
    fn from(accounts: DummyIxAccounts) -> Self {
        Self {
            pod_aligned_fee_time_scheduler: *accounts.pod_aligned_fee_time_scheduler.key,
            pod_aligned_fee_rate_limiter: *accounts.pod_aligned_fee_rate_limiter.key,
            pod_aligned_fee_market_cap_scheduler: *accounts.pod_aligned_fee_market_cap_scheduler.key,
        }
    }
}

impl From<DummyIxKeys> for [AccountMeta; DUMMY_IX_ACCOUNTS_LEN] {
    fn from(keys: DummyIxKeys) -> Self {
        [
            AccountMeta {
                pubkey: keys.pod_aligned_fee_time_scheduler,
                is_signer: false,
                is_writable: false,
            },
            AccountMeta {
                pubkey: keys.pod_aligned_fee_rate_limiter,
                is_signer: false,
                is_writable: false,
            },
            AccountMeta {
                pubkey: keys.pod_aligned_fee_market_cap_scheduler,
                is_signer: false,
                is_writable: false,
            },
        ]
...
impl From<[Pubkey; DUMMY_IX_ACCOUNTS_LEN]> for DummyIxKeys {
    fn from(pubkeys: [Pubkey; DUMMY_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            pod_aligned_fee_time_scheduler: pubkeys[0],
            pod_aligned_fee_rate_limiter: pubkeys[1],
            pod_aligned_fee_market_cap_scheduler: pubkeys[2],
        }
    }
}

impl<'info> From<DummyIxAccounts<'_, 'info>> for [AccountInfo<'info>; DUMMY_IX_ACCOUNTS_LEN] {
    fn from(accounts: DummyIxAccounts<'_, 'info>) -> Self {
        [
            accounts.pod_aligned_fee_time_scheduler.clone(),
            accounts.pod_aligned_fee_rate_limiter.clone(),
            accounts.pod_aligned_fee_market_cap_scheduler.clone(),
        ]
    }
}

impl<'me, 'info> From<&'me [AccountInfo<'info>; DUMMY_IX_ACCOUNTS_LEN]> for DummyIxAccounts<'me, 'info> {
    fn from(arr: &'me [AccountInfo<'info>; DUMMY_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            pod_aligned_fee_time_scheduler: &arr[0],
            pod_aligned_fee_rate_limiter: &arr[1],
            pod_aligned_fee_market_cap_scheduler: &arr[2],
        }
    }
}

pub const DUMMY_IX_DISCM: [u8; 8] = [234, 95, 176, 185, 7, 42, 35, 159];

// Assuming DummyParams is defined elsewhere
...
#[derive(Clone, Debug, PartialEq)]
pub struct DummyIxData(pub DummyIxArgs);

impl From<DummyIxArgs> for DummyIxData {
    fn from(args: DummyIxArgs) -> Self {
        Self(args)
    }
}
...
impl DummyIxData {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        ...
        Ok(Self(DummyIxArgs::deserialize(&mut reader)?))
    }
...
pub fn dummy_ix_ix_with_program_id(
    program_id: Pubkey,
    keys: DummyIxKeys,
    args: DummyIxArgs,
) -> std::io::Result<Instruction> {
    let metas: [AccountMeta; DUMMY_IX_ACCOUNTS_LEN] = keys.into();
    let data: DummyIxData = args.into();
    Ok(Instruction {
        program_id,
        accounts: Vec::from(metas),
        data: data.try_to_vec()?,
...
pub fn dummy_ix_ix(
    ...
    dummy_ix_ix_with_program_id(crate::ID, keys, args)
}

pub fn dummy_ix_invoke_with_program_id(
    program_id: Pubkey,
    accounts: DummyIxAccounts<'_, '_>,
    args: DummyIxArgs,
) -> ProgramResult {
    let keys: DummyIxKeys = accounts.into();
    let ix = dummy_ix_ix_with_program_id(program_id, keys, args)?;
    invoke_instruction(&ix, accounts)
}

pub fn dummy_ix_invoke(
    accounts: DummyIxAccounts<'_, '_>,
    args: DummyIxArgs,
) -> ProgramResult {
    dummy_ix_invoke_with_program_id(crate::ID, accounts, args)
}

pub fn dummy_ix_invoke_signed_with_program_id(
    program_id: Pubkey,
    accounts: DummyIxAccounts<'_, '_>,
    args: DummyIxArgs,
    seeds: &[&[&[u8]]],
...
pub fn dummy_ix_invoke_signed(
    accounts: DummyIxAccounts<'_, '_>,
    args: DummyIxArgs,
    seeds: &[&[&[u8]]],
) -> ProgramResult {
    dummy_ix_invoke_signed_with_program_id(crate::ID, accounts, args, seeds)
}

pub fn dummy_ix_verify_account_keys(
    accounts: DummyIxAccounts<'_, '_>,
    keys: DummyIxKeys,
) -> Result<(), (Pubkey, Pubkey)> {
    for (actual, expected) in [
        (*accounts.pod_aligned_fee_time_scheduler.key, keys.pod_aligned_fee_time_scheduler),
        (*accounts.pod_aligned_fee_rate_limiter.key, keys.pod_aligned_fee_rate_limiter),
        (*accounts.pod_aligned_fee_market_cap_scheduler.key, keys.pod_aligned_fee_market_cap_scheduler),
    ] {
        if actual != expected {
            return Err((actual, expected));
        }
...
pub fn dummy_ix_verify_writable_privileges<'me, 'info>(
    accounts: DummyIxAccounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    Ok(())
}

pub fn dummy_ix_verify_signer_privileges<'me, 'info>(
    accounts: DummyIxAccounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    Ok(())
}

pub fn dummy_ix_verify_account_privileges<'me, 'info>(
    accounts: DummyIxAccounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    dummy_ix_verify_writable_privileges(accounts)?;
    dummy_ix_verify_signer_privileges(accounts)?;
    Ok(())
}

pub const FIX_CONFIG_FEE_PARAMS_IX_ACCOUNTS_LEN: usize = 3;

#[derive(Copy, Clone, Debug)]
pub struct FixConfigFeeParamsAccounts<'me, 'info> {
    pub config: &'me AccountInfo<'info>,
    pub operator: &'me AccountInfo<'info>,
    pub signer: &'me AccountInfo<'info>,
}
...
#[derive(Copy, Clone, Debug, PartialEq)]
pub struct FixConfigFeeParamsKeys {
    pub config: Pubkey,
    pub operator: Pubkey,
    pub signer: Pubkey,
}

impl From<FixConfigFeeParamsAccounts<'_, '_>> for FixConfigFeeParamsKeys {
    fn from(accounts: FixConfigFeeParamsAccounts) -> Self {
        Self {
            config: *accounts.config.key,
            operator: *accounts.operator.key,
            signer: *accounts.signer.key,
...
impl From<FixConfigFeeParamsKeys> for [AccountMeta; FIX_CONFIG_FEE_PARAMS_IX_ACCOUNTS_LEN] {
    fn from(keys: FixConfigFeeParamsKeys) -> Self {
        [
            AccountMeta {
                pubkey: keys.config,
                is_signer: false,
...
impl From<[Pubkey; FIX_CONFIG_FEE_PARAMS_IX_ACCOUNTS_LEN]> for FixConfigFeeParamsKeys {
    fn from(pubkeys: [Pubkey; FIX_CONFIG_FEE_PARAMS_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            config: pubkeys[0],
            operator: pubkeys[1],
            signer: pubkeys[2],
...
impl<'info> From<FixConfigFeeParamsAccounts<'_, 'info>> for [AccountInfo<'info>; FIX_CONFIG_FEE_PARAMS_IX_ACCOUNTS_LEN] {
    fn from(accounts: FixConfigFeeParamsAccounts<'_, 'info>) -> Self {
        [
            accounts.config.clone(),
            accounts.operator.clone(),
            accounts.signer.clone(),
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; FIX_CONFIG_FEE_PARAMS_IX_ACCOUNTS_LEN]> for FixConfigFeeParamsAccounts<'me, 'info> {
    fn from(arr: &'me [AccountInfo<'info>; FIX_CONFIG_FEE_PARAMS_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            config: &arr[0],
            operator: &arr[1],
            signer: &arr[2],
...
pub const FIX_CONFIG_FEE_PARAMS_IX_DISCM: [u8; 8] = [38, 30, 216, 81, 250, 177, 243, 254];

// Assuming BaseFeeParameters is defined elsewhere
// If not, you would need to define it here

#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq, Default)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct FixConfigFeeParamsIxArgs {
    pub params: BaseFeeParameters,
}

#[derive(Clone, Debug, PartialEq)]
pub struct FixConfigFeeParamsIxData(pub FixConfigFeeParamsIxArgs);

impl From<FixConfigFeeParamsIxArgs> for FixConfigFeeParamsIxData {
    fn from(args: FixConfigFeeParamsIxArgs) -> Self {
        Self(args)
    }
}

impl FixConfigFeeParamsIxData {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        let mut reader = buf;
        let mut maybe_discm = [0u8; 8];
        reader.read_exact(&mut maybe_discm)?;
        if maybe_discm != FIX_CONFIG_FEE_PARAMS_IX_DISCM {
            return Err(
                std::io::Error::new(
                    std::io::ErrorKind::Other,
                    format!(
                        "discm does not match. Expected: {:?}. Received: {:?}",
                        FIX_CONFIG_FEE_PARAMS_IX_DISCM, maybe_discm
                    ),
                ),
            );
        }
        Ok(Self(FixConfigFeeParamsIxArgs::deserialize(&mut reader)?))
    }
...
pub fn fix_config_fee_params_ix_with_program_id(
    program_id: Pubkey,
    keys: FixConfigFeeParamsKeys,
    args: FixConfigFeeParamsIxArgs,
) -> std::io::Result<Instruction> {
    let metas: [AccountMeta; FIX_CONFIG_FEE_PARAMS_IX_ACCOUNTS_LEN] = keys.into();
    let data: FixConfigFeeParamsIxData = args.into();
    Ok(Instruction {
        program_id,
        accounts: Vec::from(metas),
        data: data.try_to_vec()?,
...
pub fn fix_config_fee_params_ix(
    keys: FixConfigFeeParamsKeys,
    args: FixConfigFeeParamsIxArgs,
) -> std::io::Result<Instruction> {
    fix_config_fee_params_ix_with_program_id(crate::ID, keys, args)
}

pub fn fix_config_fee_params_invoke_with_program_id(
    program_id: Pubkey,
    accounts: FixConfigFeeParamsAccounts<'_, '_>,
    args: FixConfigFeeParamsIxArgs,
) -> ProgramResult {
    let keys: FixConfigFeeParamsKeys = accounts.into();
    let ix = fix_config_fee_params_ix_with_program_id(program_id, keys, args)?;
    invoke_instruction(&ix, accounts)
}

pub fn fix_config_fee_params_invoke(
    accounts: FixConfigFeeParamsAccounts<'_, '_>,
    args: FixConfigFeeParamsIxArgs,
) -> ProgramResult {
    fix_config_fee_params_invoke_with_program_id(crate::ID, accounts, args)
}

pub fn fix_config_fee_params_invoke_signed_with_program_id(
    program_id: Pubkey,
    accounts: FixConfigFeeParamsAccounts<'_, '_>,
    args: FixConfigFeeParamsIxArgs,
    seeds: &[&[&[u8]]],
...
pub fn fix_config_fee_params_invoke_signed(
    accounts: FixConfigFeeParamsAccounts<'_, '_>,
    args: FixConfigFeeParamsIxArgs,
    seeds: &[&[&[u8]]],
) -> ProgramResult {
    fix_config_fee_params_invoke_signed_with_program_id(crate::ID, accounts, args, seeds)
}

pub fn fix_config_fee_params_verify_account_keys(
    accounts: FixConfigFeeParamsAccounts<'_, '_>,
    keys: FixConfigFeeParamsKeys,
) -> Result<(), (Pubkey, Pubkey)> {
    for (actual, expected) in [
...
pub fn fix_config_fee_params_verify_writable_privileges<'me, 'info>(
    accounts: FixConfigFeeParamsAccounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    for should_be_writable in [
        accounts.config,
    ] {
...
pub fn fix_config_fee_params_verify_signer_privileges<'me, 'info>(
    accounts: FixConfigFeeParamsAccounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    for should_be_signer in [
        accounts.signer,
...
pub fn fix_config_fee_params_verify_account_privileges<'me, 'info>(
    accounts: FixConfigFeeParamsAccounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    fix_config_fee_params_verify_writable_privileges(accounts)?;
    fix_config_fee_params_verify_signer_privileges(accounts)?;
    Ok(())
}

pub const FIX_POOL_FEE_PARAMS_IX_ACCOUNTS_LEN: usize = 3;

#[derive(Copy, Clone, Debug)]
pub struct FixPoolFeeParamsAccounts<'me, 'info> {
    pub pool: &'me AccountInfo<'info>,
    pub operator: &'me AccountInfo<'info>,
    pub signer: &'me AccountInfo<'info>,
}
...
#[derive(Copy, Clone, Debug, PartialEq)]
pub struct FixPoolFeeParamsKeys {
    pub pool: Pubkey,
    pub operator: Pubkey,
    pub signer: Pubkey,
}

impl From<FixPoolFeeParamsAccounts<'_, '_>> for FixPoolFeeParamsKeys {
    fn from(accounts: FixPoolFeeParamsAccounts) -> Self {
        Self {
            pool: *accounts.pool.key,
            operator: *accounts.operator.key,
            signer: *accounts.signer.key,
...
impl From<FixPoolFeeParamsKeys> for [AccountMeta; FIX_POOL_FEE_PARAMS_IX_ACCOUNTS_LEN] {
    fn from(keys: FixPoolFeeParamsKeys) -> Self {
        [
            AccountMeta {
                pubkey: keys.pool,
                is_signer: false,
...
impl From<[Pubkey; FIX_POOL_FEE_PARAMS_IX_ACCOUNTS_LEN]> for FixPoolFeeParamsKeys {
    fn from(pubkeys: [Pubkey; FIX_POOL_FEE_PARAMS_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            pool: pubkeys[0],
            operator: pubkeys[1],
            signer: pubkeys[2],
...
impl<'info> From<FixPoolFeeParamsAccounts<'_, 'info>> for [AccountInfo<'info>; FIX_POOL_FEE_PARAMS_IX_ACCOUNTS_LEN] {
    fn from(accounts: FixPoolFeeParamsAccounts<'_, 'info>) -> Self {
        [
            accounts.pool.clone(),
            accounts.operator.clone(),
            accounts.signer.clone(),
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; FIX_POOL_FEE_PARAMS_IX_ACCOUNTS_LEN]> for FixPoolFeeParamsAccounts<'me, 'info> {
    fn from(arr: &'me [AccountInfo<'info>; FIX_POOL_FEE_PARAMS_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            pool: &arr[0],
            operator: &arr[1],
            signer: &arr[2],
...
pub const FIX_POOL_FEE_PARAMS_IX_DISCM: [u8; 8] = [132, 98, 81, 196, 44, 58, 120, 193];
...
#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq, Default)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct FixPoolFeeParamsIxArgs {
    pub params: BaseFeeParameters,
}

#[derive(Clone, Debug, PartialEq)]
pub struct FixPoolFeeParamsIxData(pub FixPoolFeeParamsIxArgs);

impl From<FixPoolFeeParamsIxArgs> for FixPoolFeeParamsIxData {
    fn from(args: FixPoolFeeParamsIxArgs) -> Self {
        Self(args)
    }
}

impl FixPoolFeeParamsIxData {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        let mut reader = buf;
        let mut maybe_discm = [0u8; 8];
        reader.read_exact(&mut maybe_discm)?;
        if maybe_discm != FIX_POOL_FEE_PARAMS_IX_DISCM {
            return Err(
                std::io::Error::new(
                    std::io::ErrorKind::Other,
                    format!(
                        "discm does not match. Expected: {:?}. Received: {:?}",
                        FIX_POOL_FEE_PARAMS_IX_DISCM, maybe_discm
                    ),
                ),
            );
        }
        Ok(Self(FixPoolFeeParamsIxArgs::deserialize(&mut reader)?))
    }
...
pub fn fix_pool_fee_params_ix_with_program_id(
    program_id: Pubkey,
    keys: FixPoolFeeParamsKeys,
    args: FixPoolFeeParamsIxArgs,
) -> std::io::Result<Instruction> {
    let metas: [AccountMeta; FIX_POOL_FEE_PARAMS_IX_ACCOUNTS_LEN] = keys.into();
    let data: FixPoolFeeParamsIxData = args.into();
    Ok(Instruction {
        program_id,
        accounts: Vec::from(metas),
        data: data.try_to_vec()?,
...
pub fn fix_pool_fee_params_ix(
    keys: FixPoolFeeParamsKeys,
    args: FixPoolFeeParamsIxArgs,
) -> std::io::Result<Instruction> {
    fix_pool_fee_params_ix_with_program_id(crate::ID, keys, args)
}

pub fn fix_pool_fee_params_invoke_with_program_id(
    program_id: Pubkey,
    accounts: FixPoolFeeParamsAccounts<'_, '_>,
    args: FixPoolFeeParamsIxArgs,
) -> ProgramResult {
    let keys: FixPoolFeeParamsKeys = accounts.into();
    let ix = fix_pool_fee_params_ix_with_program_id(program_id, keys, args)?;
    invoke_instruction(&ix, accounts)
}

pub fn fix_pool_fee_params_invoke(
    accounts: FixPoolFeeParamsAccounts<'_, '_>,
    args: FixPoolFeeParamsIxArgs,
) -> ProgramResult {
    fix_pool_fee_params_invoke_with_program_id(crate::ID, accounts, args)
}

pub fn fix_pool_fee_params_invoke_signed_with_program_id(
    program_id: Pubkey,
    accounts: FixPoolFeeParamsAccounts<'_, '_>,
    args: FixPoolFeeParamsIxArgs,
    seeds: &[&[&[u8]]],
...
pub fn fix_pool_fee_params_invoke_signed(
    accounts: FixPoolFeeParamsAccounts<'_, '_>,
    args: FixPoolFeeParamsIxArgs,
    seeds: &[&[&[u8]]],
) -> ProgramResult {
    fix_pool_fee_params_invoke_signed_with_program_id(crate::ID, accounts, args, seeds)
}

pub fn fix_pool_fee_params_verify_account_keys(
    accounts: FixPoolFeeParamsAccounts<'_, '_>,
    keys: FixPoolFeeParamsKeys,
) -> Result<(), (Pubkey, Pubkey)> {
    for (actual, expected) in [
...
pub fn fix_pool_fee_params_verify_writable_privileges<'me, 'info>(
    accounts: FixPoolFeeParamsAccounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    for should_be_writable in [
        accounts.pool,
    ] {
...
pub fn fix_pool_fee_params_verify_signer_privileges<'me, 'info>(
    accounts: FixPoolFeeParamsAccounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    for should_be_signer in [
        accounts.signer,
...
pub fn fix_pool_fee_params_verify_account_privileges<'me, 'info>(
    accounts: FixPoolFeeParamsAccounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    fix_pool_fee_params_verify_writable_privileges(accounts)?;
    fix_pool_fee_params_verify_signer_privileges(accounts)?;
    Ok(())
}
...
pub const LOCK_INNER_POSITION_IX_ACCOUNTS_LEN: usize = 6;

#[derive(Copy, Clone, Debug)]
pub struct LockInnerPositionAccounts<'me, 'info> {
    pub pool: &'me AccountInfo<'info>,
    pub position: &'me AccountInfo<'info>,
    pub position_nft_account: &'me AccountInfo<'info>,
    pub owner: &'me AccountInfo<'info>,
...
#[derive(Copy, Clone, Debug, PartialEq)]
pub struct LockInnerPositionKeys {
    pub pool: Pubkey,
    pub position: Pubkey,
    pub position_nft_account: Pubkey,
    pub owner: Pubkey,
...
impl From<LockInnerPositionAccounts<'_, '_>> for LockInnerPositionKeys {
    fn from(accounts: LockInnerPositionAccounts) -> Self {
        Self {
            pool: *accounts.pool.key,
            position: *accounts.position.key,
            position_nft_account: *accounts.position_nft_account.key,
...
impl From<LockInnerPositionKeys> for [AccountMeta; LOCK_INNER_POSITION_IX_ACCOUNTS_LEN] {
    fn from(keys: LockInnerPositionKeys) -> Self {
        [
            AccountMeta {
                pubkey: keys.pool,
                is_signer: false,
...
impl From<[Pubkey; LOCK_INNER_POSITION_IX_ACCOUNTS_LEN]> for LockInnerPositionKeys {
    fn from(pubkeys: [Pubkey; LOCK_INNER_POSITION_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            pool: pubkeys[0],
            position: pubkeys[1],
            position_nft_account: pubkeys[2],
...
impl<'info> From<LockInnerPositionAccounts<'_, 'info>>
    for [AccountInfo<'info>; LOCK_INNER_POSITION_IX_ACCOUNTS_LEN]
{
    fn from(accounts: LockInnerPositionAccounts<'_, 'info>) -> Self {
        [
            accounts.pool.clone(),
            accounts.position.clone(),
            accounts.position_nft_account.clone(),
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; LOCK_INNER_POSITION_IX_ACCOUNTS_LEN]>
    for LockInnerPositionAccounts<'me, 'info>
{
    fn from(arr: &'me [AccountInfo<'info>; LOCK_INNER_POSITION_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            pool: &arr[0],
            position: &arr[1],
            position_nft_account: &arr[2],
...
pub const LOCK_INNER_POSITION_IX_DISCM: [u8; 8] = [72, 19, 49, 204, 18, 122, 23, 90];

#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq, Default)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct LockInnerPositionIxArgs {
    pub params: VestingParameters,
}

#[derive(Clone, Debug, PartialEq)]
pub struct LockInnerPositionIxData(pub LockInnerPositionIxArgs);

impl From<LockInnerPositionIxArgs> for LockInnerPositionIxData {
    fn from(args: LockInnerPositionIxArgs) -> Self {
        Self(args)
    }
}

impl LockInnerPositionIxData {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        let mut reader = buf;
        let mut maybe_discm = [0u8; 8];
        reader.read_exact(&mut maybe_discm)?;
        if maybe_discm != LOCK_INNER_POSITION_IX_DISCM {
            return Err(std::io::Error::new(
                std::io::ErrorKind::Other,
                format!(
                    "discm does not match. Expected: {:?}. Received: {:?}",
                    LOCK_INNER_POSITION_IX_DISCM, maybe_discm
                ),
            ));
        }
        Ok(Self(LockInnerPositionIxArgs::deserialize(&mut reader)?))
    }
...
pub fn lock_inner_position_ix_with_program_id(
    program_id: Pubkey,
    keys: LockInnerPositionKeys,
    args: LockInnerPositionIxArgs,
) -> std::io::Result<Instruction> {
    let metas: [AccountMeta; LOCK_INNER_POSITION_IX_ACCOUNTS_LEN] = keys.into();
    let data: LockInnerPositionIxData = args.into();
    Ok(Instruction {
        program_id,
        accounts: Vec::from(metas),
        data: data.try_to_vec()?,
...
pub fn lock_inner_position_ix(
    keys: LockInnerPositionKeys,
    args: LockInnerPositionIxArgs,
) -> std::io::Result<Instruction> {
    lock_inner_position_ix_with_program_id(crate::ID, keys, args)
}

pub fn lock_inner_position_invoke_with_program_id(
    program_id: Pubkey,
    accounts: LockInnerPositionAccounts<'_, '_>,
    args: LockInnerPositionIxArgs,
) -> ProgramResult {
    let keys: LockInnerPositionKeys = accounts.into();
    let ix = lock_inner_position_ix_with_program_id(program_id, keys, args)?;
    invoke_instruction(&ix, accounts)
}

pub fn lock_inner_position_invoke(
    accounts: LockInnerPositionAccounts<'_, '_>,
    args: LockInnerPositionIxArgs,
) -> ProgramResult {
    lock_inner_position_invoke_with_program_id(crate::ID, accounts, args)
}

pub fn lock_inner_position_invoke_signed_with_program_id(
    program_id: Pubkey,
    accounts: LockInnerPositionAccounts<'_, '_>,
    args: LockInnerPositionIxArgs,
    seeds: &[&[&[u8]]],
...
pub fn lock_inner_position_invoke_signed(
    accounts: LockInnerPositionAccounts<'_, '_>,
    args: LockInnerPositionIxArgs,
    seeds: &[&[&[u8]]],
) -> ProgramResult {
    lock_inner_position_invoke_signed_with_program_id(crate::ID, accounts, args, seeds)
}

pub fn lock_inner_position_verify_account_keys(
    accounts: LockInnerPositionAccounts<'_, '_>,
    keys: LockInnerPositionKeys,
) -> Result<(), (Pubkey, Pubkey)> {
    for (actual, expected) in [
...
pub fn lock_inner_position_verify_writable_privileges<'me, 'info>(
...
pub fn lock_inner_position_verify_account_privileges<'me, 'info>(
    accounts: LockInnerPositionAccounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    lock_inner_position_verify_writable_privileges(accounts)?;
    lock_inner_position_verify_signer_privileges(accounts)?;
    Ok(())
}
...
pub const SPLIT_POSITION_IX_ACCOUNTS_LEN: usize = 9;

#[derive(Copy, Clone, Debug)]
pub struct SplitPositionAccounts<'me, 'info> {
    ...
    pub first_owner: &'me AccountInfo<'info>,
    /// Owner of second position
    pub second_owner: &'me AccountInfo<'info>,
    pub event_authority: &'me AccountInfo<'info>,
    pub program: &'me AccountInfo<'info>,
}

#[derive(Copy, Clone, Debug, PartialEq)]
pub struct SplitPositionKeys {
    pub pool: Pubkey,
...
impl From<SplitPositionAccounts<'_, '_>> for SplitPositionKeys {
    fn from(accounts: SplitPositionAccounts) -> Self {
        Self {
            pool: *accounts.pool.key,
            ...
            first_owner: *accounts.first_owner.key,
            second_owner: *accounts.second_owner.key,
            event_authority: *accounts.event_authority.key,
            program: *accounts.program.key,
        }
    }
...
impl From<SplitPositionKeys> for [AccountMeta; SPLIT_POSITION_IX_ACCOUNTS_LEN] {
    fn from(keys: SplitPositionKeys) -> Self {
        [
            AccountMeta {
                pubkey: keys.pool,
                is_signer: false,
            ...
            AccountMeta {
                pubkey: keys.first_owner,
                is_signer: true,
                is_writable: false,
            },
            AccountMeta {
                pubkey: keys.second_owner,
                is_signer: true,
                is_writable: false,
            },
            AccountMeta {
...
impl From<[Pubkey; SPLIT_POSITION_IX_ACCOUNTS_LEN]> for SplitPositionKeys {
    fn from(pubkeys: [Pubkey; SPLIT_POSITION_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            pool: pubkeys[0],
            first_position: pubkeys[1],
            first_position_nft_account: pubkeys[2],
            second_position: pubkeys[3],
            second_position_nft_account: pubkeys[4],
            first_owner: pubkeys[5],
            second_owner: pubkeys[6],
            event_authority: pubkeys[7],
            program: pubkeys[8],
        }
    }
...
impl<'info> From<SplitPositionAccounts<'_, 'info>> for [AccountInfo<'info>; SPLIT_POSITION_IX_ACCOUNTS_LEN] {
    fn from(accounts: SplitPositionAccounts<'_, 'info>) -> Self {
        [
            accounts.pool.clone(),
            ...
            accounts.first_owner.clone(),
            accounts.second_owner.clone(),
            accounts.event_authority.clone(),
            accounts.program.clone(),
        ]
    }
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; SPLIT_POSITION_IX_ACCOUNTS_LEN]> for SplitPositionAccounts<'me, 'info> {
    fn from(arr: &'me [AccountInfo<'info>; SPLIT_POSITION_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            pool: &arr[0],
            first_position: &arr[1],
            first_position_nft_account: &arr[2],
            second_position: &arr[3],
            second_position_nft_account: &arr[4],
            first_owner: &arr[5],
            second_owner: &arr[6],
            event_authority: &arr[7],
            program: &arr[8],
...
pub const SPLIT_POSITION_IX_DISCM: [u8; 8] = [172, 241, 221, 138, 161, 29, 253, 42];

// Assuming SplitPositionParameters is defined elsewhere
// If not, you would need to define it here

#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq, Default)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SplitPositionIxArgs {
    pub params: SplitPositionParameters,
}

#[derive(Clone, Debug, PartialEq)]
pub struct SplitPositionIxData(pub SplitPositionIxArgs);

impl From<SplitPositionIxArgs> for SplitPositionIxData {
    fn from(args: SplitPositionIxArgs) -> Self {
        Self(args)
    }
}

impl SplitPositionIxData {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        let mut reader = buf;
        let mut maybe_discm = [0u8; 8];
        reader.read_exact(&mut maybe_discm)?;
        if maybe_discm != SPLIT_POSITION_IX_DISCM {
            return Err(
                std::io::Error::new(
                    std::io::ErrorKind::Other,
                    format!(
                        "discm does not match. Expected: {:?}. Received: {:?}",
                        SPLIT_POSITION_IX_DISCM, maybe_discm
                    ),
                ),
            );
        }
        Ok(Self(SplitPositionIxArgs::deserialize(&mut reader)?))
    }
...
pub fn split_position_ix_with_program_id(
    program_id: Pubkey,
    keys: SplitPositionKeys,
    args: SplitPositionIxArgs,
) -> std::io::Result<Instruction> {
    let metas: [AccountMeta; SPLIT_POSITION_IX_ACCOUNTS_LEN] = keys.into();
    let data: SplitPositionIxData = args.into();
    Ok(Instruction {
        program_id,
        accounts: Vec::from(metas),
        data: data.try_to_vec()?,
...
pub fn split_position_ix(
    keys: SplitPositionKeys,
    args: SplitPositionIxArgs,
) -> std::io::Result<Instruction> {
    split_position_ix_with_program_id(crate::ID, keys, args)
}

pub fn split_position_invoke_with_program_id(
    program_id: Pubkey,
    accounts: SplitPositionAccounts<'_, '_>,
    args: SplitPositionIxArgs,
) -> ProgramResult {
    let keys: SplitPositionKeys = accounts.into();
    let ix = split_position_ix_with_program_id(program_id, keys, args)?;
    invoke_instruction(&ix, accounts)
}

pub fn split_position_invoke(
    accounts: SplitPositionAccounts<'_, '_>,
    args: SplitPositionIxArgs,
) -> ProgramResult {
    split_position_invoke_with_program_id(crate::ID, accounts, args)
}

pub fn split_position_invoke_signed_with_program_id(
    program_id: Pubkey,
    accounts: SplitPositionAccounts<'_, '_>,
    args: SplitPositionIxArgs,
    seeds: &[&[&[u8]]],
...
pub fn split_position_invoke_signed(
    accounts: SplitPositionAccounts<'_, '_>,
    args: SplitPositionIxArgs,
    seeds: &[&[&[u8]]],
) -> ProgramResult {
    split_position_invoke_signed_with_program_id(crate::ID, accounts, args, seeds)
}

pub fn split_position_verify_account_keys(
    accounts: SplitPositionAccounts<'_, '_>,
    keys: SplitPositionKeys,
) -> Result<(), (Pubkey, Pubkey)> {
    for (actual, expected) in [
        ...
        (*accounts.first_owner.key, keys.first_owner),
        (*accounts.second_owner.key, keys.second_owner),
        (*accounts.event_authority.key, keys.event_authority),
        (*accounts.program.key, keys.program),
    ] {
        if actual != expected {
...
pub fn split_position_verify_writable_privileges<'me, 'info>(
    accounts: SplitPositionAccounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    for should_be_writable in [
        accounts.pool,
...
pub fn split_position_verify_signer_privileges<'me, 'info>(
    accounts: SplitPositionAccounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    for should_be_signer in [
        accounts.first_owner,
        accounts.second_owner,
    ] {
        if !should_be_signer.is_signer {
            return Err((should_be_signer, ProgramError::MissingRequiredSignature));
        }
...
pub fn split_position_verify_account_privileges<'me, 'info>(
    accounts: SplitPositionAccounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    split_position_verify_writable_privileges(accounts)?;
    split_position_verify_signer_privileges(accounts)?;
    Ok(())
}

pub const SPLIT_POSITION2_IX_ACCOUNTS_LEN: usize = 9;

#[derive(Copy, Clone, Debug)]
pub struct SplitPosition2Accounts<'me, 'info> {
    /// CHECK: The pool account
    pub pool: &'me AccountInfo<'info>,
    /// The first position
    pub first_position: &'me AccountInfo<'info>,
...
impl From<SplitPosition2Accounts<'_, '_>> for SplitPosition2Keys {
    fn from(accounts: SplitPosition2Accounts) -> Self {
        Self {
            pool: *accounts.pool.key,
            first_position: *accounts.first_position.key,
            first_position_nft_account: *accounts.first_position_nft_account.key,
...
impl From<SplitPosition2Keys> for [AccountMeta; SPLIT_POSITION2_IX_ACCOUNTS_LEN] {
    fn from(keys: SplitPosition2Keys) -> Self {
        [
            AccountMeta {
                pubkey: keys.pool,
                is_signer: false,
...
impl From<[Pubkey; SPLIT_POSITION2_IX_ACCOUNTS_LEN]> for SplitPosition2Keys {
    fn from(pubkeys: [Pubkey; SPLIT_POSITION2_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            pool: pubkeys[0],
            first_position: pubkeys[1],
            first_position_nft_account: pubkeys[2],
...
impl<'info> From<SplitPosition2Accounts<'_, 'info>> for [AccountInfo<'info>; SPLIT_POSITION2_IX_ACCOUNTS_LEN] {
    fn from(accounts: SplitPosition2Accounts<'_, 'info>) -> Self {
        [
            accounts.pool.clone(),
            accounts.first_position.clone(),
            accounts.first_position_nft_account.clone(),
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; SPLIT_POSITION2_IX_ACCOUNTS_LEN]> for SplitPosition2Accounts<'me, 'info> {
    fn from(arr: &'me [AccountInfo<'info>; SPLIT_POSITION2_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            pool: &arr[0],
            first_position: &arr[1],
            first_position_nft_account: &arr[2],
...
pub const SPLIT_POSITION2_IX_DISCM: [u8; 8] = [221, 147, 228, 207, 140, 212, 17, 119];

#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq, Default)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SplitPosition2IxArgs {
    pub numerator: u32,
}

#[derive(Clone, Debug, PartialEq)]
pub struct SplitPosition2IxData(pub SplitPosition2IxArgs);

impl From<SplitPosition2IxArgs> for SplitPosition2IxData {
    fn from(args: SplitPosition2IxArgs) -> Self {
        Self(args)
    }
}

impl SplitPosition2IxData {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        let mut reader = buf;
        let mut maybe_discm = [0u8; 8];
        reader.read_exact(&mut maybe_discm)?;
        if maybe_discm != SPLIT_POSITION2_IX_DISCM {
            return Err(
                std::io::Error::new(
                    std::io::ErrorKind::Other,
                    format!(
                        "discm does not match. Expected: {:?}. Received: {:?}",
                        SPLIT_POSITION2_IX_DISCM, maybe_discm
                    ),
                ),
            );
        }
        Ok(Self(SplitPosition2IxArgs::deserialize(&mut reader)?))
    }
...
pub fn split_position2_ix_with_program_id(
    program_id: Pubkey,
    keys: SplitPosition2Keys,
    args: SplitPosition2IxArgs,
) -> std::io::Result<Instruction> {
    let metas: [AccountMeta; SPLIT_POSITION2_IX_ACCOUNTS_LEN] = keys.into();
    let data: SplitPosition2IxData = args.into();
    Ok(Instruction {
        program_id,
        accounts: Vec::from(metas),
        data: data.try_to_vec()?,
...
pub fn split_position2_ix(
    keys: SplitPosition2Keys,
    args: SplitPosition2IxArgs,
) -> std::io::Result<Instruction> {
    split_position2_ix_with_program_id(crate::ID, keys, args)
}

pub fn split_position2_invoke_with_program_id(
    program_id: Pubkey,
    accounts: SplitPosition2Accounts<'_, '_>,
    args: SplitPosition2IxArgs,
) -> ProgramResult {
    let keys: SplitPosition2Keys = accounts.into();
    let ix = split_position2_ix_with_program_id(program_id, keys, args)?;
    invoke_instruction(&ix, accounts)
}

pub fn split_position2_invoke(
    accounts: SplitPosition2Accounts<'_, '_>,
    args: SplitPosition2IxArgs,
) -> ProgramResult {
    split_position2_invoke_with_program_id(crate::ID, accounts, args)
}

pub fn split_position2_invoke_signed_with_program_id(
    program_id: Pubkey,
    accounts: SplitPosition2Accounts<'_, '_>,
    args: SplitPosition2IxArgs,
    seeds: &[&[&[u8]]],
...
pub fn split_position2_invoke_signed(
    accounts: SplitPosition2Accounts<'_, '_>,
    args: SplitPosition2IxArgs,
    seeds: &[&[&[u8]]],
) -> ProgramResult {
    split_position2_invoke_signed_with_program_id(crate::ID, accounts, args, seeds)
}

pub fn split_position2_verify_account_keys(
    accounts: SplitPosition2Accounts<'_, '_>,
    keys: SplitPosition2Keys,
) -> Result<(), (Pubkey, Pubkey)> {
    for (actual, expected) in [
...
pub fn split_position2_verify_writable_privileges<'me, 'info>(
    accounts: SplitPosition2Accounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    for should_be_writable in [
        accounts.pool,
        accounts.first_position,
...
pub fn split_position2_verify_signer_privileges<'me, 'info>(
    accounts: SplitPosition2Accounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    for should_be_signer in [
        accounts.first_owner,
...
pub fn split_position2_verify_account_privileges<'me, 'info>(
    accounts: SplitPosition2Accounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    split_position2_verify_writable_privileges(accounts)?;
    split_position2_verify_signer_privileges(accounts)?;
    Ok(())
}
...
pub const SWAP2_IX_ACCOUNTS_LEN: usize = 14;

#[derive(Copy, Clone, Debug)]
pub struct Swap2Accounts<'me, 'info> {
    /// CHECK: Pool authority account with fixed address
    pub pool_authority: &'me AccountInfo<'info>,
    /// Pool account
    pub pool: &'me AccountInfo<'info>,
    ...
    pub referral_token_account: Option<&'me AccountInfo<'info>>,
    pub event_authority: &'me AccountInfo<'info>,
    pub program: &'me AccountInfo<'info>,
}
...
impl From<Swap2Accounts<'_, '_>> for Swap2Keys {
    fn from(accounts: Swap2Accounts) -> Self {
        Self {
            ...
            token_a_program: *accounts.token_a_program.key,
            token_b_program: *accounts.token_b_program.key,
            referral_token_account: accounts.referral_token_account.map(|acc| *acc.key),
            event_authority: *accounts.event_authority.key,
            program: *accounts.program.key,
        }
    }
...
impl From<Swap2Keys> for [AccountMeta; SWAP2_IX_ACCOUNTS_LEN] {
    fn from(keys: Swap2Keys) -> Self {
        let mut metas = [
            ...
            // Placeholder for referral_token_account (will be overwritten if Some)
            AccountMeta {
        ...
        // Set the referral token account if it exists
        if let Some(pubkey) = keys.referral_token_account {
            metas[11] = AccountMeta {
                pubkey,
                is_signer: false,
                is_writable: true,
            };
...
impl From<[Pubkey; SWAP2_IX_ACCOUNTS_LEN]> for Swap2Keys {
    fn from(pubkeys: [Pubkey; SWAP2_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            ...
            token_a_program: pubkeys[9],
            token_b_program: pubkeys[10],
            referral_token_account: Some(pubkeys[11]),
            event_authority: pubkeys[12],
            program: pubkeys[13],
        }
    }
...
impl<'info> From<Swap2Accounts<'_, 'info>> for [AccountInfo<'info>; SWAP2_IX_ACCOUNTS_LEN] {
    fn from(accounts: Swap2Accounts<'_, 'info>) -> Self {
        let mut infos = [
            ...
            accounts.token_b_program.clone(),
            // Placeholder for referral_token_account (will be overwritten if Some)
            accounts.pool.clone(), // Temporary clone, will be replaced
            accounts.event_authority.clone(),
            accounts.program.clone(),
        ];

        // Set the referral token account if it exists
        if let Some(referral) = accounts.referral_token_account {
            infos[11] = referral.clone();
        }
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; SWAP2_IX_ACCOUNTS_LEN]> for Swap2Accounts<'me, 'info> {
    fn from(arr: &'me [AccountInfo<'info>; SWAP2_IX_ACCOUNTS_LEN]) -> Self {
        // Check if the referral token account is the default pubkey or a real account
        // This is a simplified approach - in practice you might need a better way to detect optional accounts
        let referral_token_account = if *arr[11].key != Pubkey::default() {
            Some(&arr[11])
        } else {
            None
        };
...
// Assuming SwapParameters2 is defined elsewhere
// If not, you would need to define it here
...
pub fn swap2_verify_account_keys(
    ...
    // Check optional referral token account if present
    match (accounts.referral_token_account, keys.referral_token_account) {
        (Some(actual), Some(expected)) => {
            if *actual.key != expected {
                return Err((*actual.key, expected));
            }
        }
        (None, None) => (),
        (Some(actual), None) => return Err((*actual.key, Pubkey::default())),
        (None, Some(expected)) => return Err((Pubkey::default(), expected)),
    }
...
pub fn swap2_verify_writable_privileges<'me, 'info>(
    ...
    // Add referral token account if present
    if let Some(referral) = accounts.referral_token_account {
        writable_accounts.push(referral);
    }
    
    for should_be_writable in writable_accounts {
        if !should_be_writable.is_writable {
            return Err((should_be_writable, ProgramError::InvalidAccountData));
        }
    }
...
#[derive(Copy, Clone, Debug)]
pub struct UpdatePoolFeesAccounts<'me, 'info> {
    pub pool: &'me AccountInfo<'info>,
    pub operator: &'me AccountInfo<'info>,
    pub signer: &'me AccountInfo<'info>,
    pub event_authority: &'me AccountInfo<'info>,
...
impl From<UpdatePoolFeesAccounts<'_, '_>> for UpdatePoolFeesKeys {
    fn from(accounts: UpdatePoolFeesAccounts) -> Self {
        Self {
            pool: *accounts.pool.key,
            operator: *accounts.operator.key,
            signer: *accounts.signer.key,
...
impl From<UpdatePoolFeesKeys> for [AccountMeta; UPDATE_POOL_FEES_IX_ACCOUNTS_LEN] {
    fn from(keys: UpdatePoolFeesKeys) -> Self {
        [
            AccountMeta {
                pubkey: keys.pool,
                is_signer: false,
...
impl From<[Pubkey; UPDATE_POOL_FEES_IX_ACCOUNTS_LEN]> for UpdatePoolFeesKeys {
    fn from(pubkeys: [Pubkey; UPDATE_POOL_FEES_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            pool: pubkeys[0],
            operator: pubkeys[1],
            signer: pubkeys[2],
...
impl<'info> From<UpdatePoolFeesAccounts<'_, 'info>> for [AccountInfo<'info>; UPDATE_POOL_FEES_IX_ACCOUNTS_LEN] {
    fn from(accounts: UpdatePoolFeesAccounts<'_, 'info>) -> Self {
        [
            accounts.pool.clone(),
            accounts.operator.clone(),
            accounts.signer.clone(),
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; UPDATE_POOL_FEES_IX_ACCOUNTS_LEN]> for UpdatePoolFeesAccounts<'me, 'info> {
    fn from(arr: &'me [AccountInfo<'info>; UPDATE_POOL_FEES_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            pool: &arr[0],
            operator: &arr[1],
            signer: &arr[2],
...
pub const UPDATE_POOL_FEES_IX_DISCM: [u8; 8] = [118, 217, 203, 179, 60, 8, 70, 89];

// Assuming UpdatePoolFeesParameters is defined elsewhere
// If not, you would need to define it here

#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq, Default)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct UpdatePoolFeesIxArgs {
    pub params: UpdatePoolFeesParameters,
}

#[derive(Clone, Debug, PartialEq)]
pub struct UpdatePoolFeesIxData(pub UpdatePoolFeesIxArgs);

impl From<UpdatePoolFeesIxArgs> for UpdatePoolFeesIxData {
    fn from(args: UpdatePoolFeesIxArgs) -> Self {
        Self(args)
    }
}

impl UpdatePoolFeesIxData {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        let mut reader = buf;
        let mut maybe_discm = [0u8; 8];
        reader.read_exact(&mut maybe_discm)?;
        if maybe_discm != UPDATE_POOL_FEES_IX_DISCM {
            return Err(
                std::io::Error::new(
                    std::io::ErrorKind::Other,
                    format!(
                        "discm does not match. Expected: {:?}. Received: {:?}",
                        UPDATE_POOL_FEES_IX_DISCM, maybe_discm
                    ),
                ),
            );
        }
        Ok(Self(UpdatePoolFeesIxArgs::deserialize(&mut reader)?))
    }
...
pub fn update_pool_fees_ix_with_program_id(
    program_id: Pubkey,
    keys: UpdatePoolFeesKeys,
    args: UpdatePoolFeesIxArgs,
) -> std::io::Result<Instruction> {
    let metas: [AccountMeta; UPDATE_POOL_FEES_IX_ACCOUNTS_LEN] = keys.into();
    let data: UpdatePoolFeesIxData = args.into();
    Ok(Instruction {
        program_id,
        accounts: Vec::from(metas),
        data: data.try_to_vec()?,
...
pub fn update_pool_fees_ix(
    keys: UpdatePoolFeesKeys,
    args: UpdatePoolFeesIxArgs,
) -> std::io::Result<Instruction> {
    update_pool_fees_ix_with_program_id(crate::ID, keys, args)
}

pub fn update_pool_fees_invoke_with_program_id(
    program_id: Pubkey,
    accounts: UpdatePoolFeesAccounts<'_, '_>,
    args: UpdatePoolFeesIxArgs,
) -> ProgramResult {
    let keys: UpdatePoolFeesKeys = accounts.into();
    let ix = update_pool_fees_ix_with_program_id(program_id, keys, args)?;
    invoke_instruction(&ix, accounts)
}

pub fn update_pool_fees_invoke(
    accounts: UpdatePoolFeesAccounts<'_, '_>,
    args: UpdatePoolFeesIxArgs,
) -> ProgramResult {
    update_pool_fees_invoke_with_program_id(crate::ID, accounts, args)
}

pub fn update_pool_fees_invoke_signed_with_program_id(
    program_id: Pubkey,
    accounts: UpdatePoolFeesAccounts<'_, '_>,
    args: UpdatePoolFeesIxArgs,
    seeds: &[&[&[u8]]],
...
pub fn update_pool_fees_invoke_signed(
    accounts: UpdatePoolFeesAccounts<'_, '_>,
    args: UpdatePoolFeesIxArgs,
    seeds: &[&[&[u8]]],
) -> ProgramResult {
    update_pool_fees_invoke_signed_with_program_id(crate::ID, accounts, args, seeds)
}

pub fn update_pool_fees_verify_account_keys(
    accounts: UpdatePoolFeesAccounts<'_, '_>,
    keys: UpdatePoolFeesKeys,
) -> Result<(), (Pubkey, Pubkey)> {
    for (actual, expected) in [
...
pub fn update_pool_fees_verify_writable_privileges<'me, 'info>(
    accounts: UpdatePoolFeesAccounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    for should_be_writable in [
        accounts.pool,
    ] {
...
pub fn update_pool_fees_verify_signer_privileges<'me, 'info>(
    accounts: UpdatePoolFeesAccounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    for should_be_signer in [
        accounts.signer,
...
pub fn update_pool_fees_verify_account_privileges<'me, 'info>(
    accounts: UpdatePoolFeesAccounts<'me, 'info>,
) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
    update_pool_fees_verify_writable_privileges(accounts)?;
    update_pool_fees_verify_signer_privileges(accounts)?;
    Ok(())
}
...
pub struct ZapProtocolFeeAccounts<'me, 'info> {
    ...
    /// Token program
    pub token_program: &'me AccountInfo<'info>,
    /// CHECK: Sysvar instructions account with fixed address
...
impl From<[Pubkey; ZAP_PROTOCOL_FEE_IX_ACCOUNTS_LEN]> for ZapProtocolFeeKeys {
    fn from(pubkeys: [Pubkey; ZAP_PROTOCOL_FEE_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            ...
            receiver_token: pubkeys[4],
            operator: pubkeys[5],
            signer: pubkeys[6],
            token_program: pubkeys[7],
            sysvar_instructions: pubkeys[8],
        }
    }
}

impl<'info> From<ZapProtocolFeeAccounts<'_, 'info>> for [AccountInfo<'info>; ZAP_PROTOCOL_FEE_IX_ACCOUNTS_LEN] {
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; ZAP_PROTOCOL_FEE_IX_ACCOUNTS_LEN]> for ZapProtocolFeeAccounts<'me, 'info> {
    fn from(arr: &'me [AccountInfo<'info>; ZAP_PROTOCOL_FEE_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            ...
            token_vault: &arr[2],
            token_mint: &arr[3],
            receiver_token: &arr[4],
            operator: &arr[5],
            signer: &arr[6],
            token_program: &arr[7],
            sysvar_instructions: &arr[8],
        }
    }
}

pub const ZAP_PROTOCOL_FEE_IX_DISCM: [u8; 8] = [213, 155, 187, 34, 56, 182, 91, 240];
        ...
        if maybe_discm != ZAP_PROTOCOL_FEE_IX_DISCM {
            return Err(
                std::io::Error::new(
                    ...
                    format!(
                        "discm does not match. Expected: {:?}. Received: {:?}",
                        ZAP_PROTOCOL_FEE_IX_DISCM, maybe_discm
                    ),
                ),
            );
        }
        Ok(Self(ZapProtocolFeeIxArgs::deserialize(&mut reader)?))
    }
...
pub fn zap_protocol_fee_ix(
    ...
    zap_protocol_fee_ix_with_program_id(crate::ID, keys, args)
}
...
pub fn zap_protocol_fee_invoke(
    ...
    zap_protocol_fee_invoke_with_program_id(crate::ID, accounts, args)
}
...
pub fn zap_protocol_fee_invoke_signed(
    ...
    zap_protocol_fee_invoke_signed_with_program_id(crate::ID, accounts, args, seeds)
}
