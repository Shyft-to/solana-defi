...
pub async fn connect_and_stream(
    ...
    println!("Streaming for Migration Transaction from Pumpfun to PumpSwap AMM...");
...
fn pump_amm_formatter(parsed_txn: ParsedTransaction) -> Option<ParsedTransaction> {
